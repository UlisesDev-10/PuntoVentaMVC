 ...
 */
public class VentanaVista extends JInternalFrame {
    ...
    public VentanaVista(String titulo) {
    ...
    private void inicializarComponentes() {
        ...
        bverInactivos = crearBoton("Ver Inactivos", new Color(255, 193, 7)); // Amarillo
        ...
        panelBotones.add(bverInactivos);
     ...
     */
    public JButton getBverInactivos() {
        return bverInactivos;
    }
}
